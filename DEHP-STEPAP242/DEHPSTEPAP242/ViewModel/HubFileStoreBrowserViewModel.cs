...
namespace DEHPSTEPAP242.ViewModel
{
	...
	public class HubFileStoreBrowserViewModel : ReactiveObject, IHubFileStoreBrowserViewModel
	{
		...
		/// <summary>
		/// Current path to a STEP file in the DomainFileStore
		/// </summary>
		...
		/// 
		/// Files correspond to the current <see cref="Iteration"/>
		/// and <see cref="EngineeringModel"/>.
		/// </summary>
		private void UpdateFileList()
		{
			...
			hubController.OpenIteration.DomainFileStore.FirstOrDefault(d => d.Owner == hubController.CurrentDomainOfExpertise);
