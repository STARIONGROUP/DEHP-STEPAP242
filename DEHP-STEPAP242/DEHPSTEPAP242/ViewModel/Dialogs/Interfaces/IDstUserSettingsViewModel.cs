// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IDstUserSettingsViewModel.cs" company="Open Engineering S.A.">
...
{
    public interface IDstUserSettingsViewModel 
    {
        /// <summary>
        /// This method handles the complete user setting dialog box workflow.
        /// </summary>
